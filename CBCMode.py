...
# Permutation Tables (Provided in the notebook)
...
def des_round(L, R, K):
    ...
    print(f"Expanded R0 = {expanded_R}")
    ...
    print(f"New R = {new_R}\n")
    new_R_formatted = ' '.join(new_R[i:i + 8] for i in range(0, len(new_R), 8))
    try:
        new_R_Text = binary_to_text(new_R_formatted)
        print(f"New R Text = {new_R_Text}\n")
...
# 16 round keys (48 bits each)
key = ["010101010101010101010101010101010101010101010101" for _ in range(16)]

ciphertext = des_encrypt(binary_PlainText, key)

def binary_to_text(binary_str):
    binary_values = binary_str.split()  # Ensure binary is split into 8-bit chunks
